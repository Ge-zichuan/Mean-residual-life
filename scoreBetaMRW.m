function scoreVal = scoreBetaMRW(parasLower,xall,wall,zdiffallN,zdiffallT,...
...
khprimevec = kernel2(btxall./bandTwo,kerDT,d+1,'Epanechnikov')/(((bandnh31*bandadjnhn34)^(d+1))*(banddh22*bandadjnhd36));
% a1 = ans(:,:,1);a2 = ans(:,:,2);hist(a1(:));s = waitforbuttonpress;hist(a2(:));a3 = ans(:,:,3);s = waitforbuttonpress;hist(a3(:));
for t = 1:d

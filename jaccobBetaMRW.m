function [stdVal,jaccobVal] = jaccobBetaMRW(parasLower,xall,wall,zdiffallN,zdiffallT,zdiffall,kbzN,kbzT,kbzND,kbzTD...
...
btransxN = btransx; % paras1 include upper d-by-d block.
...
khprimevecT = kernel2(btxallT/(bandnh*bandadjnhn),kerD,d,'Epanechnikov')/(bandnh*bandadjnhn)^(d+1);

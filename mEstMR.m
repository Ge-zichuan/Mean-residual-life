function m = mEstMR(parasLower,inputt,inputg,xall,zall,deltaall,samplesize,bands,d,upperLimit,group)
estSample = length(inputg(:,1));
uniqueT = unique(inputt);
intgral1 = lambdaCumulEstMR(parasLower,inputt,inputg,xall,zall,deltaall,samplesize,bands,d,group);

...
simulations = 200; % number of repeat times
...
%   sum(deltaall)/samplen
  ...
  bands(1,:) = [bandez1,1,10]; % tuning the bandwidth in estimating \beta
  bands(2,:) = [bandb,0.1,1]; % tuning the bandwidth in estimating \beta
  bands(3,:) = [bandez1,100,100]; % tuning the bandwidth in estimating \beta
...
save(strcat('betaResult',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'resultBeta');
save(strcat('betaAddResult',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'resultBetaAdd');
save(strcat('betaPropResult',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'resultBetaProp');
save(strcat('betaProp2Result',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'resultBetaProp2');
save(strcat('mAddResult',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'estmAdd');
save(strcat('mPropResult',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'estmProp');
save(strcat('mProp2Result',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'estmProp2');
save(strcat('X',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'xallAll');
save(strcat('Z',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'zallAll');
save(strcat('T',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'tallAll');
save(strcat('C',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'callAll');
save(strcat('Delta',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'deltaallAll');
save(strcat('censoringDist',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'censoringDist');
save(strcat('censoringK',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'censoringK');
save(strcat('bandsAdj',num2str(filenum1),'_',num2str(paraIndStart),'new.mat'),'bands');
